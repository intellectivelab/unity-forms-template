...
The official Unity Forms template for [Create React App](https://github.com/facebook/create-react-app).
...
To use this template, add --template @intellective/unity-forms when creating a new app.

For example:

```sh
create-react-app my-app --template @intellective/unity-forms

# or
npx create-react-app my-app --template @intellective/unity-forms

# or
yarn create-react-app my-app --template @intellective/unity-forms
```
